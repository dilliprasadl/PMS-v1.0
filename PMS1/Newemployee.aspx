        ...
        <ContentTemplate>
            ...
            <div class="card card-outline-info" style="width: 1300px;">
                ...
                <div class="card-header">
                    ...
                    <h3 class="m-b-0 text-white" style="font-family: 'Mallanna', sans-serif; font-size: 22px; text-align: center;">Registration</h3>
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="ddlrole" runat="server">
                                      ...
                                      <asp:ListItem Value="Admin">Admin</asp:ListItem>
                                              ...
                                              <asp:ListItem Value="Assigner">Assigner</asp:ListItem>

                                <asp:ListItem Value="CSR">CSR</asp:ListItem>

                                              <asp:ListItem Value="CRM">CRM</asp:ListItem>

                                <asp:ListItem Value="Wellcome Call">Welcome Call</asp:ListItem>

                                              <asp:ListItem Value="Data Team">Data Team</asp:ListItem>

                                 <asp:ListItem Value="Tech Team">Tech Team</asp:ListItem>
                             ...
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Font-Bold="true" Font-Size="Large"  InitialValue="0" ControlToValidate="ddlselect" ErrorMessage="*" Display="Dynamic" SetFocusOnError="true" ForeColor="Red" ValidationGroup="fill"></asp:RequiredFieldValidator>
