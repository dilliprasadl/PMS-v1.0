<%@ Page Title="" Language="C#" MasterPageFile="~/Newprocess.Master" AutoEventWireup="true" CodeBehind="viewemployee.aspx.cs" Inherits="PMS1.viewemployee" EnableEventValidation="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <%--<script>
        $(document).ready(function() {
            document.getElementById("#ContentPlaceHolder1_Grd_downlod").style.visibility = "hidden";
        });
