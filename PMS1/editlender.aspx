<%@ Page Language="C#" MasterPageFile="Newprocess.Master" AutoEventWireup="true" CodeBehind="editlender.aspx.cs" Inherits="PMS1.editlender" %>
...
<p class="bs-example bs-baseline-top">
     <asp:Button runat="server" ID="btn_update" OnClick="btn_update_Click" Text="Update" ValidationGroup="fill" CssClass="btn btn-primary btn-block"/>
						</p></div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
