<%@ Page Title="" Language="C#" MasterPageFile="~/Newprocess.Master" AutoEventWireup="true" CodeBehind="New_orders.aspx.cs" Inherits="PMS1.New_orders" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--<div>
        <table style="align-content:center">
            <tr>
                <td>OrderId</td>
                <td> <asp:TextBox ID="txtoid" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>OrderName</td>
                <td> <asp:TextBox ID="txtoname" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>OrderReceivedTime</td>
                <td> <asp:TextBox ID="txtort" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td>OrderReceiveddate</td>
                <td>  
            ...
            <div class="card card-outline-info" style="width: 1300px;">
                ...
                <table class="card-body" style="font-size:smaller">
                  ...
                  <div class="card-header">
                    ...
                    <table class="card-body" style="font-size:smaller">
                         <tr><td>Phone Number</td><td>:</td><td><asp:TextBox runat="server" ID="txtphnumber"></asp:TextBox></td>
